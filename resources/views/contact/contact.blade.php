				...
				<div class="grid_12">
					<div class="menu_block">
						<nav class="horizontal-nav full-width horizontalNav-notprocessed">
							<ul class="sf-menu">
								<li ><a href="{{route('home.home')}}">ABOUT</a></li>
								<li><a href="{{route('home.tour')}}">HOT TOURS</a></li>
								<li><a href="{{route('home.offer')}}">SPECIAL OFFERS</a></li>
								<li><a href="{{route('home.blog')}}">BLOG</a></li>
								<li><a class="current" href="{{route('home.contact')}}">CONTACTS</a></li>
							</ul>
						</nav>
						<div class="clear"></div>
					</div>
